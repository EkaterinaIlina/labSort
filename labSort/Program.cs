...
namespace labSort
{
    internal class Program
    {
        ...
        {
            int intMinSize = 0;
            int intMaxSize = 10000;
            int doubleMinSize = 0;
            int doubleMaxSize = 10000;
            int step = 1000;
        ...
        private static void TestSort
            ...
            try
            {
                StreamWriter avgTimeFile = new StreamWriter(avgTimeFileName, false, Encoding.UTF8) ;
                StreamWriter arraySizeFile = new StreamWriter(arraySizeFileName, false, Encoding.UTF8);
